...
def start_game():
  ...
  return outcomes[choices[0]][choices[1]][choices[2]] == "You just found a historical item worth billions.|You then returned home happily.|Game Over..."
